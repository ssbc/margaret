...
func (fake *FakeQuery) Reverse(arg1 bool) error {
	...
	fake.recordInvocation("Reverse", []interface{}{arg1})
	fake.reverseMutex.Unlock()
	if fake.ReverseStub != nil {
		return fake.ReverseStub(arg1)
	}
	if specificReturn {
		return ret.result1
	}
	fakeReturns := fake.reverseReturns
	return fakeReturns.result1
}

func (fake *FakeQuery) ReverseCallCount() int {
	fake.reverseMutex.RLock()
	defer fake.reverseMutex.RUnlock()
	return len(fake.reverseArgsForCall)
}

func (fake *FakeQuery) ReverseCalls(stub func(bool) error) {
	fake.reverseMutex.Lock()
	defer fake.reverseMutex.Unlock()
	fake.ReverseStub = stub
}

func (fake *FakeQuery) ReverseArgsForCall(i int) bool {
	fake.reverseMutex.RLock()
	defer fake.reverseMutex.RUnlock()
	argsForCall := fake.reverseArgsForCall[i]
	return argsForCall.arg1
}

func (fake *FakeQuery) ReverseReturns(result1 error) {
	fake.reverseMutex.Lock()
	defer fake.reverseMutex.Unlock()
...
func (fake *FakeQuery) ReverseReturnsOnCall(i int, result1 error) {
	fake.reverseMutex.Lock()
	defer fake.reverseMutex.Unlock()
	fake.ReverseStub = nil
